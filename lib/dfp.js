 ...
 */
/**
 * MOD: Since AWS Lambda does not allow file IO permission in current directory
 * Update the file path to /tmp instead
 */
...
var criteriaKeyPath = path.resolve('/tmp/criteriaKeyStore');
var criteriaValuePath = path.resolve('/tmp/criteriaValueStore');
var adUnitPath = path.resolve('/tmp/adUnitStore');
var orderPath = path.resolve('/tmp/orderStore');
var labelPath = path.resolve('/tmp/labelStore');
